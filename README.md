...
| [`Persona_setup/`](Persona_setup/README.md) | Set up user personas for pilots: [`HBA/`](Persona_setup/HBA/README.md) (creates a brand-new synthetic user and drives it through the High Bill Alert email trigger; CLI-flag/env-var driven, no `config.json`), and the rest driven by `config.json`: [`HER/`](Persona_setup/HER/README.md) (pilot config sync, DB SQL, S3 payload upload, NBI string resources, and the SHC 2.0 mock pipeline), [`BestRateEmail/`](Persona_setup/BestRateEmail/README.md) (user-scoped Best Rate email), [`TOUOnboarding/`](Persona_setup/TOUOnboarding/README.md) (user-scoped TOU Rate Onboarding email), and one folder per persona group that turns an existing pilot-88001 user into a reference persona by writing its rate plan + configs - [`Standard/`](Persona_setup/Standard/README.md), [`TOU/`](Persona_setup/TOU/README.md), [`EV/`](Persona_setup/EV/README.md), [`Solar/`](Persona_setup/Solar/README.md), [`PoolPump/`](Persona_setup/PoolPump/README.md), [`BudgetBilling/`](Persona_setup/BudgetBilling/README.md), [`SolarTrueUp/`](Persona_setup/SolarTrueUp/README.md). |
